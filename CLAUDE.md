...
- Ferry from Guernsey: about 45 minutes. Link ferry mentions to sarkshipping.gg, except on conversion landing pages (/getting-to-sark-guide, formerly /free-guide), which carry no external links, per John, 14 July 2026. Never publish a specific last-ferry time, sailings change by season.
...
- Retreat dates: September 2027 is 25 to 30 September 2027, changed from 18 to 23 per Helen (the venue), 19 July 2026; never reintroduce the old 2027 dates. September 2026 (was 12 to 17) is POSTPONED, per John, 19 July 2026: quiet switch, the site sells only 2027, no public postponement notice, /retreats-on-sark is the 2027 booking page, booked 2026 guests are handled personally by Nadia. Do not resurrect 2026 sales pages or dates. June 2027: Helen suggested 7 to 12 June 2027 (19 July 2026), NOT confirmed and NOT published; when confirmed, the waitlist hears first, then the site, in that order.
